...
import 'package:login_page/classutil/question_model2.dart';
import 'package:login_page/widgets/courses/course_complete.dart';
...
class _QuizState extends State<Quiz2> {
  List<Questions2> questionList = getQuestions2();
