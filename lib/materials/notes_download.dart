...
class nDownload extends StatefulWidget {
  const nDownload({Key? key}) : super(key: key);

  @override
  _nDownloadState createState() => _nDownloadState();
}

class _nDownloadState extends State<nDownload> {
  List<String> pdfList = [];
  ...
  Future<void> downloadPdf(String fileName) async {
    try {
      final ref = firebase_storage.FirebaseStorage.instance
          .ref('files/studynotes/python/$fileName');
